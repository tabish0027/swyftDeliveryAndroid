            ...
            public void onClick(View v) {
                if (order_list_declined.getVisibility() == View.VISIBLE) {
                    ...
                    if (Databackbone.getinstance().ar_orders_diclined.size() == 0)
                        Databackbone.getinstance().showAlsertBox(activity_order_status.this, getResources().getString(R.string.declined_parcels), getResources().getString(R.string.no_data_found));
                    else {
            ...
            public void onClick(View v) {
                if (order_list_reattempt.getVisibility() == View.VISIBLE) {
                    ...
                    if (Databackbone.getinstance().ar_orders_reattempt.size() == 0)
                        Databackbone.getinstance().showAlsertBox(activity_order_status.this, getResources().getString(R.string.reattempt_parcels), getResources().getString(R.string.no_data_found));
                    else {
            ...
            public void onClick(View v) {
                if (order_list_delivered.getVisibility() == View.VISIBLE) {
                    ...
                    if (Databackbone.getinstance().ar_orders_delivered.size() == 0)
                        Databackbone.getinstance().showAlsertBox(activity_order_status.this, getResources().getString(R.string.delivered_parcels), getResources().getString(R.string.no_data_found));
                    else {
