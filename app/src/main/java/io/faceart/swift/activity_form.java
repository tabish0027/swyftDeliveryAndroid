...
public class activity_form extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_delivered.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent signatureWindow = new Intent(activity_form.this, activity_signature_pad.class);
                signatureWindow.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                signatureWindow.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                activity_form.this.startActivity(signatureWindow);
